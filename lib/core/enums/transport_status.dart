enum TransportStatus {
  ...
  vehicleReported('VEHICLE_REPORTED', 'Vehicle Reported', true),
  containerPickedUp('CONTAINER_PICKED_UP', 'Container Picked Up', true),
  inTransit('IN_TRANSIT', 'In Transit', true),
  atPortCfs('AT_PORT_CFS', 'At Port / CFS', true),
  containerDelivered('CONTAINER_DELIVERED', 'Container Delivered', true),
